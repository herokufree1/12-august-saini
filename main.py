...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/+3qEFduORMGczYmRl")]])
keyboard = InlineKeyboardMarkup(
    [
        [InlineKeyboardButton(text="🛠️ Help", url="https://t.me/+3qEFduORMGczYmRl"), InlineKeyboardButton(text="🛠️ Repo", url="https://t.me/+3qEFduORMGczYmRl")],
    ]
)
